...
Because Household Pulse Survey does not provide data at the county level, these food insufficiency numbers are estimates from a model. The model uses the food insufficiency rate of `r data_params$state` and the county unemployment rates to estimate food insufficiency for each county.
