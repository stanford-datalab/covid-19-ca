...
v %>% 
  ...
  mutate(
    ...
    across(.cols = ends_with("_n"), signif, digits = 3),
    across(
      .cols = ends_with("_pct"), 
...
v %>% 
  choropleth(
    ...
    tooltip = 
      "<strong>{area}</strong><br/>Food insufficiency: {format(adult_pct, trim = TRUE, nsmall = 1)}%",
...
The relationship between food insufficiency and unemployment that held between 2001 and 2018 appears to have changed during the pandemic. May 2020 experienced both high unemployment and high food insufficiency, but food insufficiency is much higher than past years would predict. 
