...
v %>% 
  ...
  mutate(
    date_end = format(date_end, "%Y %b %d"),
    n = signif(n, digits = 3),
    pct = format(round(pct, digits = 1), nsmall = 1)
  ) %>% 
  rename(
    "Survey end date" = date_end, 
    "Estimated adults reporting food insufficiency" = n,
  ...
  reactable(
    ...
    columns = 
      list(
        "Estimated adults reporting food insufficiency" = 
...
v %>% 
  ...
  mutate(
    food_insufficiency = 
      format(round(food_insufficiency, digits = 1), nsmall = 1)
  ) %>% 
  select(
    "County" = NAME,
    "Estimated percentage of adults reporting food insufficiency" = 
