...
In the most recent survey period that ended `r month_day(v$date_end)`, an estimated `r format(round(v$pct, digits = 1))`% of `r params$area` adults, or approximately `r format(signif(v$n, digits = 3), big.mark = ",")` adults, lived in households with food insecurity.
...
v %>% 
  choropleth(
    ...
    tooltip = 
      "<strong>{area}</strong><br/>Food insecurity: {format(food_insecurity, trim = TRUE, nsmall = 1)}%",
    legend_title = "Food insecurity<br/>in adults"
  )
```
...
v %>% 
  ...
  labs(
    title = "Food insecurity by age group",
    subtitle = 
      str_glue("For the survey period that ended {month_day(hps_puf_date_end)}"),
    x = "Age group",
    y = "Percentage of age group that is food insecure",
    color = NULL,
    caption = "Source: Census Bureau, Household Pulse Survey."
  )
```
...
v %>% 
  ...
  labs(
    ...
    subtitle = 
      str_glue("For the survey period that ended {month_day(hps_puf_date_end)}"),
    x = NULL,
    y = "Percentage of gender that is food insecure",
    color = NULL,
    caption = "Source: Census Bureau, Household Pulse Survey."
  )
```
...
v %>% 
  ...
  theme(legend.position = "bottom") +
  labs(
    title = "Food insecurity by race and ethnicity",
    subtitle = 
      str_glue("For the survey period that ended {month_day(hps_puf_date_end)}"),
    x = NULL,
    y = "Percentage of group that is food insecure",
    color = NULL,
    caption = "Source: Census Bureau, Household Pulse Survey."
  )
```
